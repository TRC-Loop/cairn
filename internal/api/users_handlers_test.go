...
func newSettingsTestServer(t *testing.T) (*httptest.Server, *store.Queries, *auth.SessionService) {
	...
	srv := httptest.NewServer(NewRouter(logger, db, q, nil, nil, sessionSvc, authH, nil, checksH, nil, nil, nil, nil, nil, nil, usersH, sysH, retH, nil, nil, nil, false, "dev", "unknown"))
	t.Cleanup(srv.Close)
