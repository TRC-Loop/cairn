...
func newComponentsTestServer(t *testing.T) (*httptest.Server, *store.Queries, *sql.DB) {
	...
	srv := httptest.NewServer(NewRouter(logger, db, q, nil, nil, sessionSvc, authH, nil, checksH, componentsH, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "dev", "unknown"))
	t.Cleanup(srv.Close)
	return srv, q, db
}
