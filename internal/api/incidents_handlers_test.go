...
func newIncidentsTestServer(t *testing.T) (*httptest.Server, *store.Queries, *incident.Service, *captureNotifier) {
	...
	srv := httptest.NewServer(NewRouter(logger, db, q, nil, nil, sessionSvc, authH, nil, nil, nil, nil, nil, nil, incidentsH, nil, nil, nil, nil, nil, nil, nil, nil, false, "dev", "unknown"))
	t.Cleanup(srv.Close)
